...
<main>
  <section class="banner bg-tertiary position-relative overflow-hidden py-5">
    <div class="container">
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-lg-6">
          <div class="block text-center text-lg-start pe-0 pe-xl-5">
            <span class="badge text-uppercase px-3 py-2 mb-3 d-inline-block" style="background: linear-gradient(to right, #3b82f6, #6366f1); color: white;">Tentang Kami</span>
            <h1 class="text-capitalize mb-4">Temukan <span style="color: #3b82f6;">{{ $config->title ?? 'Moon Studio' }}</span></h1>

            <p class="mb-4" style="font-size: 18px;">{{ $config->detail ?? 'Destinasi utama untuk pengalaman fotografi profesional dengan fasilitas canggih dan ruang kreatif.' }}</p>

            <div class="d-flex mb-4 flex-wrap justify-content-center justify-content-lg-start">
              <div class="me-4 mb-3 text-center text-lg-start">
                <div class="rounded-circle p-3 mb-2 d-inline-block" style="background-color: rgba(59, 130, 246, 0.1); transition: all 0.3s ease;">
                  <i class="bi bi-camera fs-4" style="color: #3b82f6;"></i>
                </div>
                <h5 class="fw-semibold mb-1">Peralatan Profesional</h5>
                <p class="text-muted small">Kamera & lighting high-end</p>
              </div>

              <div class="me-4 mb-3 text-center text-lg-start">
                <div class="rounded-circle p-3 mb-2 d-inline-block" style="background-color: rgba(59, 130, 246, 0.1); transition: all 0.3s ease;">
                  <i class="bi bi-palette fs-4" style="color: #3b82f6;"></i>
                </div>
                <h5 class="fw-semibold mb-1">Berbagai Tema</h5>
                <p class="text-muted small">20+ backdrop berbeda</p>
              </div>

              <div class="mb-3 text-center text-lg-start">
                <div class="rounded-circle p-3 mb-2 d-inline-block" style="background-color: rgba(59, 130, 246, 0.1); transition: all 0.3s ease;">
                  <i class="bi bi-calendar-check fs-4" style="color: #3b82f6;"></i>
                </div>
                <h5 class="fw-semibold mb-1">Booking Mudah</h5>
                <p class="text-muted small">Reservasi online 24/7</p>
              </div>
            </div>

            <a href="{{ route('filament.client.auth.login') }}" class="btn btn-primary" >Pesan Sekarang<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
          </div>
        </div>
      </div>
    </div>
